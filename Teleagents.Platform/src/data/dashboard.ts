...
export const mostCalledAgents: AgentCallCount[] = [
  { name: "Survey Caller", calls: 312, color: "#4ade80" },
  { name: "Support Agent", calls: 243, color: "#f9a8d4" },
  { name: "Sales Assistant", calls: 156, color: "#fbbf24" },
  { name: "Appointment Bot", calls: 89, color: "#6b7280" },
  { name: "Lead Qualifier", calls: 47, color: "#d1d5db" },
]
